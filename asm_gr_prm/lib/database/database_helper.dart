...
class DatabaseHelper {
  ...
  static const String tableSpendingJars = 'spending_jars';
  ...
  Future<Database> _initDB(String filePath) async {
    ...
    return await openDatabase(
      ...
      onOpen: (db) async {
        await _createSpendingJarsTable(db);
      },
  ...
  Future<void> _createSpendingJarsTable(Database db) async {
    await db.execute('''
      CREATE TABLE IF NOT EXISTS $tableSpendingJars (
        id INTEGER PRIMARY KEY AUTOINCREMENT,
        name TEXT NOT NULL,
        month TEXT NOT NULL,
        ...
        colorValue INTEGER NOT NULL DEFAULT 4293467791,
        FOREIGN KEY (userId) REFERENCES $tableUsers(id) ON DELETE CASCADE,
        FOREIGN KEY (categoryId) REFERENCES $tableCategories(id) ON DELETE SET NULL,
